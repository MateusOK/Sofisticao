...
class BlueCard(customtkinter.CTkFrame):
     def __init__(self, master, **kwargs):
        ...
        # status - container
        status_bar = customtkinter.CTkFrame(self, bg_color="#2D9CDB",  fg_color="#2D9CDB", width=71, height=2)
        status_bar.grid(row=0, column=0, sticky=customtkinter.SW,padx=15, pady=26.5)


        # in progress - status - container
        in_progress_text = customtkinter.CTkLabel(self, text="Concluído", font=customtkinter.CTkFont(
            family="Open Sans", size=16, weight="bold"), fg_color="white", text_color="#2D9CDB")
