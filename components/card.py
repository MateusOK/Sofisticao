...
class Card(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        logo_label.grid(row=0, column=0,
                        sticky=customtkinter.NW, padx=15, pady=37)
        ...
        animal_title.grid(
            row=0, column=0, sticky=customtkinter.NW, padx=114, pady=36)
        ...
        owner_title.grid(
            row=0, column=0, sticky=customtkinter.NW, padx=114, pady=60)
        ...
        owner_title_placeholder.grid(
            row=0, column=0, sticky=customtkinter.NW, padx=157, pady=60)

        contact_title = customtkinter.CTkLabel(self, text="Contato:", font=customtkinter.CTkFont(
            family="Open Sans", size=14, weight="bold"), fg_color="white", text_color="#6A6A6A")
        contact_title.grid(
            row=0, column=0, sticky=customtkinter.NW, padx=114, pady=79)

        contact_title_placeholder = customtkinter.CTkLabel(self, text="(13) 9684-4814", font=customtkinter.CTkFont(
            family="Open Sans", size=14), fg_color="white", text_color="#6A6A6A")
        contact_title_placeholder.grid(
            row=0, column=0, sticky=customtkinter.NW, padx=175, pady=79)
        ...
        date_label = customtkinter.CTkLabel(
            self, text="", image=date_icon, fg_color="white")
        date_label.grid(row=0, column=0,
                        sticky=customtkinter.SW, padx=114, pady=47)
        ...
        clock_label = customtkinter.CTkLabel(
            self, text="", image=clock_icon, fg_color="white")
        clock_label.grid(
            row=0, column=0, sticky=customtkinter.SW, padx=230, pady=47)

        clock_text = customtkinter.CTkLabel(self, text="14h00", font=customtkinter.CTkFont(
            family="Open Sans", size=14, weight="bold"), fg_color="white", text_color="#292929")
        clock_text.grid(row=0, column=0,
                        sticky=customtkinter.SW, padx=251, pady=47)

        # status - container
        status_bar = customtkinter.CTkFrame(
            self, bg_color="#F2994A",  fg_color="#F2994A", width=71, height=2)
        status_bar.grid(row=0, column=0,
                        sticky=customtkinter.SW, padx=15, pady=26.5)
        ...
        in_progress_text.grid(
            row=0, column=0, sticky=customtkinter.SW, padx=95, pady=14)
        ...
        description_title.grid(
            row=0, column=0, sticky=customtkinter.NW, padx=339, pady=36)
