...
def servicesWindow():
    ...
    client_button = ctk.CTkButton(root, text="       Clientes", image=client_logo, corner_radius=7, text_color="black", 
                                ...
                                font=ctk.CTkFont(family="Open Sans", size=12, weight="bold"), hover_color="#F2800D", command=backClients)
    ...
    new_button = ctk.CTkButton(root, image=newButton_logo, text="  Novo", corner_radius=7,fg_color="#FFA826",
                                 height=35, width=180, bg_color="white", font=ctk.CTkFont(family="Open Sans", size=12, weight="bold"), hover_color="#F2800D", command=openService)
